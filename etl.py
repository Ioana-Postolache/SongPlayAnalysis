...
def process_song_file(cur, filepath):
    """function processes song files and inserts data into songs and artists tables"""
    # open song file
...
def process_log_file(cur, filepath):
    """function processes log files and inserts data into time, users and songplays tables"""
    # open log file
